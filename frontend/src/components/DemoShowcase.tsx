...
export default function DemoShowcase() {
  ...
  return (
    <section className="w-full max-w-4xl pt-16 pb-28 px-2">
      {/* Header */}
      <div className="text-center mb-16">
        <h2 className="text-2xl sm:text-3xl font-semibold tracking-[-0.04em] mb-2.5">
          Same video.{" "}
          <span className="text-gradient-hero">Different feeling.</span>
        </h2>
        <p className="text-[var(--muted-foreground)] text-[13px]">
          Click to hear what AI-composed music adds to your footage.
        </p>
      </div>

      {/* Before / After — two portrait videos side by side */}
      <div className="flex justify-center items-start max-w-2xl mx-auto">
        {/* Before — Original with raw audio */}
        <div className="flex-1 max-w-[260px] flex flex-col items-center gap-3">
          <button
                ...
                <div
                  className={`
                    ...
                    ${active === "before"
                      ...
                      : "bg-white/[0.06] backdrop-blur-sm group-hover/card:bg-white/[0.12] group-hover/card:scale-110"
                    }
                  `}
                >
                  {active === "before" ? (
                    ...
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-white/50 group-hover/card:text-white/80 transition-colors duration-300 ml-0.5">
        ...
        {/* Divider */}
        <div className="flex flex-col items-center justify-center self-stretch py-16 px-3 sm:px-5">
          <div className="w-px flex-1 bg-gradient-to-b from-transparent via-white/[0.08] to-transparent" />
          <span className="text-[9px] font-semibold uppercase tracking-widest text-[var(--muted)] py-3">vs</span>
          <div className="w-px flex-1 bg-gradient-to-b from-transparent via-white/[0.08] to-transparent" />
        </div>

        {/* After — with AI soundtrack */}
        <div className="flex-1 max-w-[260px] flex flex-col items-center gap-3">
          <button
          ...
          >
            <div className="aspect-[9/16] relative bg-[#08080a] overflow-hidden">
              ...
              {/* Glass now-playing card */}
              {active === "after" && (
                <div className="absolute bottom-3 inset-x-3 pointer-events-none animate-fade-up">
                  <div
                    className="relative overflow-hidden rounded-2xl backdrop-blur-2xl border border-white/[0.12] px-4 py-3"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <div className="flex items-end gap-[2px] h-3.5">
                          {[0.5, 0.85, 0.6, 1, 0.7].map((h, i) => (
                            <div
                              key={i}
                              className="w-[2.5px] rounded-full bg-[var(--accent)]/70 waveform-playing"
                      ...
                      {/* Music icon */}
                      <div className="w-7 h-7 rounded-lg bg-[var(--accent)]/[0.10] border border-[var(--accent)]/15 flex items-center justify-center shrink-0">
                        <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-[var(--accent)]">
      ...
      {/* Hint */}
      <p className="text-center text-[13px] text-[var(--muted-foreground)] mt-10">
