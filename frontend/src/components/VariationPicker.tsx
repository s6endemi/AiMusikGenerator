...
export default function VariationPicker({
  ...
  return (
    <div className="flex flex-col items-center gap-6 stagger">
      ...
      <button
        onClick={onBack}
        className="self-start text-[12px] text-[var(--muted-foreground)] hover:text-[var(--foreground)] transition-colors flex items-center gap-1.5 group"
      >
        ...
        {variations.map((v, idx) => (
          ...
          >
            ...
            <div className="flex items-center gap-2.5 mb-3">
              <div
                className={`w-6 h-6 rounded-md flex items-center justify-center text-[10px] font-semibold tabular-nums transition-all duration-300 ${
                  selected === v.file_id
      ...
      <p className="text-[11px] text-[var(--muted-foreground)]">
        Audio auto-ducks during speech
      </p>
